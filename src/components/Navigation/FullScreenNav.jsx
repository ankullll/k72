      ...
      <div ref={fullNavLinksRef} className="relative">
        ...
        <div className=" ">
          <div className="link origin-top relative border-t border-white">
            <h1 className="font-[font2] text-5xl lg:text-[7vw] text-center lg:leading-[0.9] lg:pt-4 pt-3 uppercase">
              Projets
            </h1>
            <div className="moveLink absolute text-black flex top-0 h-full bg-[#D3FD50]">
              <div className="moveX  flex items-center">
                <h2 className="whitespace-nowrap font-[font2] lg:text-[7vw] text-5xl  text-center lg:leading-[0.9] lg:pt-4 pt-3 uppercase">
                  Pour Tout voir
                </h2>
                <img
                  className="px-2 lg:h-23 h-14 rounded-full shrink-0 lg:w-48 w-32 object-cover"
                  src="/assets/small home.jpg"
                  alt=""
                />
                <h2 className="whitespace-nowrap font-[font2] lg:text-[7vw] text-5xl  text-center lg:leading-[0.9] lg:pt-4 pt-3 uppercase">
                  Pour Tout voir
                ...
                <img
                  className="px-2 lg:h-23 h-14 rounded-full shrink-0 lg:w-48 w-32 object-cover"
                  src="/assets/menu/PJC_SiteK72_Thumbnail_640x290.jpg"
                  alt=""
                />
              </div>
              <div className="moveX flex items-center">
          ...
          <div className="link origin-top relative border-t-1 border-white">
            ...
            <div className="moveLink absolute text-black flex top-0 h-full bg-[#D3FD50]">
              <div className="moveX  flex items-center">
                ...
                <img
                  className="px-2 lg:h-23 h-14 rounded-full shrink-0 lg:w-48 w-32 object-cover"
                  src="/public/assets/menu/PJC_SiteK72_Thumbnail_640x290.jpg"
                  alt=""
                />
              </div>
              <div className="moveX flex items-center">
                ...
                <img
                  className="px-2 lg:h-23 h-14 rounded-full shrink-0 lg:w-48 w-32 object-cover"
                  src="/public/assets/small home.jpg"
                  alt=""
                />
                <h2 className="whitespace-nowrap font-[font2] lg:text-[7vw] text-5xl  text-center lg:leading-[0.9] lg:pt-4 pt-3 uppercase">
                  Pour Tout voir
